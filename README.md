...
| Rockchip RK3368 (Cortex-A53 r0p3) A64 @ 1.51GHz (alt^2) | clang++-3.5.0 | 0m33.747s [^1] |

[^1]: Time from an extra tweak to the code generated by the compiler - interpreter loop hand-aligned to a multiple-of-16 address.
